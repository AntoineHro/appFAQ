...
<?php if (isset($_SESSION['user_id'])){?>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-links">
            <li><?= $user['pseudo']; ?></li>
            <li style="color: rgb(0, 255, 149)">Vous faites partie de la ligue: <br><p style="text-align: center; color:wheat;"><i><?= $user['lib_ligue']?></i></p></li>
    ...
    <h2>Bienvenue, <?= $user['pseudo']; ?> vous êtes bien connecté.</h2>
