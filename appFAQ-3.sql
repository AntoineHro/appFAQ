...
CREATE TABLE `faq` (
  ...
  `type_question` tinyint(1) DEFAULT NULL
...
(12, 'Ngolo', '$2y$10$QiAP4jaNpBtZ6WgU9YihPO.O.gFJdPIFv9twkex6/HPjSQgocYele', 'ngolo@superadmin.com', 3, 5),
...
--
ALTER TABLE `faq`
  MODIFY `id_faq` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
